                    ...
                    <form class="form-horizontal" role="form" method="POST" action="{{ url('/register') }}">
                        ...
                        <div class="form-group{{ $errors->has('password_confirmation') ? ' has-error' : '' }}">
                            ...
                            <div class="form-group" disabled="true" id="nombre_universidad" style="visibility: hidden; display: none">
                              <label for="" class="col-lg-2 control-label">Nombre Universidad</label>
                                <input type="text" class="form-control" id="nombre_universidad" name:"nombre_universidad" placeholder="Nombre Universidad">
                            </div>
